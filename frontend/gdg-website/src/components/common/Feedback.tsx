...
export const Feedback: React.FC<FeedbackProps> = ({ className = "" }) => {
        return (
                <div className={`flex flex-col items-center py-12 px-6 min-h-[420px] relative bg-[#f8f9fa] ${className}`}>
                        ...
                        <div className="bg-white border border-[#dadce0] rounded-[24px] pt-10 pb-8 px-5 sm:px-10 max-w-[540px] w-full text-center relative overflow-hidden shadow-sm">
                                <div 
                                        ...
                                        style={{ background: "linear-gradient(90deg, #4285F4 25%, #EA4335 25% 50%, #FBBC04 50% 75%, #34A853 75%)" }} 
                                />

                                <div className="w-16 h-16 rounded-full bg-[#E8F0FE] flex items-center justify-center mx-auto mb-5">
                                        <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7">
                                                <path d="M20 2H4C2.9 2 2 2.9 2 4v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 12H6l-2 2V4h16v10z" fill="#4285F4"/>
                                        </svg>
                                </div>
                                ...
                                <p className="text-[14px] text-[#5f6368] leading-relaxed mb-8 max-w-[380px] mx-auto">
                                        Have ideas on how we can improve our events, the website, or just want to get in touch? Drop an email, and our team will get back to you shortly.
                                </p>
                                ...
                                <div className="flex items-center justify-center gap-2 mt-2">
                                        <div className="text-[11px] font-medium tracking-[0.4px] text-[#5f6368] flex items-center gap-1.5 uppercase">
                                                <span className="w-1.5 h-1.5 rounded-full inline-block bg-[#4285F4]"></span>
                                                <span className="w-1.5 h-1.5 rounded-full inline-block bg-[#EA4335]"></span>
                                                <span className="w-1.5 h-1.5 rounded-full inline-block bg-[#FBBC04]"></span>
                                                <span className="w-1.5 h-1.5 rounded-full inline-block bg-[#34A853]"></span>
