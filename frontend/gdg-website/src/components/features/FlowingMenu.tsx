...
function MenuItem({ link, text, image, speed, textColor, marqueeBgColor, marqueeTextColor, borderColor, fontClass }: MenuItemProps) {
	...
	return (
		<div className="menu__item" ref={itemRef} style={{ borderColor }}>
			<div className="marquee marquee--always-visible" ref={marqueeRef} style={{ backgroundColor: marqueeBgColor }}>
				<div className="marquee__inner-wrap">
					<div className={`marquee__inner ${fontClass}`} ref={marqueeInnerRef} aria-hidden="true">
