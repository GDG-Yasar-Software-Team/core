...
export default function DomeGallery({
	...
	useEffect(() => {
		...
		const close = () => {
			...
			animatingOverlay.className =
				"absolute z-[9999] overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.35)] pointer-events-none m-0 transform-none";
	...
	const openItemFromElement = useCallback(
		(el: HTMLElement) => {
			...
			refDiv.className =
				"absolute inset-[10px] bg-transparent overflow-hidden transition-transform duration-300 item__image--reference";
			...
			overlay.className =
				"enlarge absolute z-30 overflow-hidden origin-top-left shadow-[0_10px_30px_rgba(0,0,0,0.35)]";
	...
	return (
		...
		>
			...
			>
				<div
					className="w-full h-full grid place-items-center [contain:layout_paint_size]"
					style={{
				...
				>
					<div
						...
						style={{ transform: "translateZ(calc(var(--radius) * -1))" }}
					>
						{items.map((it, i) => (
							<div
								key={`${it.x},${it.y},${i}`}
				...
				<div
					className="absolute inset-0 m-auto z-0 pointer-events-none"
					style={{
						backgroundImage:
				...
				/>
				<div
					className="absolute inset-0 m-auto z-0 pointer-events-none backdrop-blur-[3px]"
					style={{
						maskImage:
				...
				/>
				<div
					className="absolute top-0 left-0 right-0 h-[120px] z-10 pointer-events-none rotate-180"
					style={{
						background:
				...
				<div
					className="absolute inset-0 z-20 pointer-events-none flex items-center justify-center p-[var(--viewer-pad)]"
					ref={viewerRef}
				>
					<div
						ref={scrimRef}
						className="absolute inset-0 -z-10 bg-black/40 pointer-events-none opacity-0 transition-opacity duration-500 backdrop-blur-[3px]"
					/>
					<div
						ref={frameRef}
						className="h-full max-sm:h-auto max-sm:w-full aspect-square flex"
