							...
							<div className="w-full xl:w-[320px] flex flex-col sm:flex-row xl:flex-col gap-10 z-10 flex-shrink-0 text-center xl:text-left order-2 xl:order-1">
								<div className="flex-1">
									...
									<p className="text-gray-600 leading-relaxed text-[15px]">
										Meet student developers and tech enthusiasts on campus.
										Build a powerful network with like-minded peers sharing your
										tech passion.
									</p>
								</div>
								<div className="flex-1">
									...
									<p className="text-gray-600 leading-relaxed text-[15px]">
										Master new technologies across various stacks. Expand your
										horizons via hands-on workshops, code-labs, and expert-led
										tech talks.
									</p>
								</div>
							</div>
							...
							<div className="w-full xl:w-[320px] flex flex-col sm:flex-row xl:flex-col gap-10 z-10 flex-shrink-0 text-center xl:text-right order-3 xl:order-3">
								<div className="flex-1">
									...
									<p className="text-gray-600 leading-relaxed text-[15px]">
										...
										Accelerate your career growth by moving from student to
										junior developer.
									</p>
								</div>
								<div className="flex-1">
									...
									<p className="text-gray-600 leading-relaxed text-[15px]">
										Collaborate on projects, join GDG hackathons, and shape the
										digital ecosystem while crafting solutions for your
										community.
									</p>
								</div>
							</div>
