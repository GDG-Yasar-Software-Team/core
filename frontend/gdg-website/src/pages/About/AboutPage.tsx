			...
			<main className="flex-1 overflow-x-clip max-w-full">
				...
				<section className="flex flex-col lg:flex-row w-full max-w-full min-h-[75vh] overflow-x-clip">
					...
					<div className="w-full lg:w-1/2 bg-[#4285F4] p-4 sm:p-6 lg:p-0 flex items-center justify-center relative overflow-hidden">
						...
						<div className="absolute top-[-20%] right-[-30%] sm:top-[-10%] sm:right-[-10%] w-64 h-64 sm:w-96 sm:h-96 bg-white/10 rounded-full blur-3xl pointer-events-none"></div>
						<div className="absolute bottom-[-20%] left-[-30%] sm:bottom-[-10%] sm:left-[-10%] w-56 h-56 sm:w-80 sm:h-80 bg-[#34A853]/20 rounded-full blur-3xl pointer-events-none"></div>
					</div>
				</section>
								...
								<div className="w-full lg:w-1/2 p-5 sm:p-8 lg:p-20 flex flex-col justify-center">
									<div className="w-full">
										<div className="flex items-center flex-wrap gap-3 sm:gap-4 mb-6 sm:mb-8">
											...
											<div className={`inline-block px-4 py-1.5 sm:px-5 sm:py-2 rounded-full text-xs sm:text-sm font-bold tracking-wide sm:tracking-widest uppercase ${block.color} text-white shadow-sm`}>
												{block.tag}
											</div>
										</div>
