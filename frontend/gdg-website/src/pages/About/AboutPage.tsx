					...
					{[
						{
							...
							color: "bg-[#4285F4]",
							tag: "Learn By Doing",
							image: "https://raw.githubusercontent.com/GDG-Yasar-Software-Team/mail-assets/main/gdg-events/events-picture/IMG_8489.jpg",
							icon: (
								<svg
						...
						},
						{
							...
							image: "https://raw.githubusercontent.com/GDG-Yasar-Software-Team/mail-assets/main/gdg-events/events-picture/IMG_7674.jpg",
							icon: (
								<svg
