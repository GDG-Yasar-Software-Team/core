...
export const EventCard: React.FC<EventCardProps> = ({ event, isPast }) => {
	...
	return (
		<article
			className={`flex flex-col md:flex-row gap-6 p-6 bg-white rounded-lg border border-[#e0e0e0] transition-shadow duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] items-center md:items-start text-center md:text-left ${isPast ? "opacity-60" : ""}`}
		>
