...
const AdminFormListContent = () => {
	...
	return (
		<div className="min-h-screen overflow-x-hidden bg-slate-100 px-4 py-4 md:py-8">
			<div className="mx-auto max-w-6xl space-y-6">
				<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
					...
					<button
						...
						className="w-full rounded-lg bg-[#4285F4] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#3367D6] sm:w-auto"
					>
						Yeni Form Oluştur
					</button>
				</div>
				...
				<div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
					{isLoading ? (
						...
						<>
												...
												<td className="px-6 py-4">
													<div className="flex items-center justify-end gap-2">
														{confirmDeleteId === form.id ? (
															<>
																<span className="mr-1 text-xs font-medium text-red-600">
							...
							{totalPages > 1 && (
								<div className="flex flex-col gap-4 border-t border-slate-100 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-6">
									<p className="text-sm text-slate-500">Toplam {total} form</p>
